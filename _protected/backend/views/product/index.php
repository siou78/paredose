...
$title = Yii::t('app/models', 'ProductPlurar');
                    ...
                    echo GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'filter' => Html::activeDropDownList($searchModel, 'product_category_id',
                                    ArrayHelper::map(
                                        ...
                                        ->all(),
                                    'id', 'name'
                                ), ['class'=>'form-control', 'prompt' => 'Select', 'encode' => false]),
                            ],
                            'name', 
                            'price',
                            [
                            ...
                            [
                                ...
                                'buttons' => [
                                    'update' => function ($url, $model) {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['product/view','id' => $model->id, 'edit' => 't']), ['title' => Yii::t('app/labels', 'edit'),]);
                                    }
                                ],
                            ],
                        ],

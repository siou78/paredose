...
$title = Yii::t('app/models', 'UserRolePlurar');
$this->title = Yii::$app->name.' | '.$title;
$this->params['breadcrumbs'][] = $title;
?>
<div class="adminCrudWrapper">
    <div class="container-fluid user-role-index">
        <div class="row">
            <div class="col-xs-12">
                            ...
                            [
                                ...
                                'buttons' => [
                                    'update' => function ($url, $model) {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['user-role/view','id' => $model->id, 'edit' => 't']), ['title' => Yii::t('app/labels', 'edit'),]);
                                    }
                                ],
                            ],
                        ],
